...
// Weather Bloc: The bloc layer's responsibility is to respond to events from the presentation layer with new states.
//The bloc layer as the bridge between the user interface (presentation layer) and the data layer.
